        ...
        var core = {
            ...
            leftPanel: function (element) {
                ...
                var ganttLeftPanel = $('<div class="leftPanel"/>')
                    .append($('<div class="row spacer"><table class="spacer-title"><tr><th>Stage</th><th>Approver</th></tr></table>')
            ...
            createProgressBar: function (label, desc, classNames, dataObj) {
                label = label || "";
                var bar = $('<div class="bar"><div class="fn-label" hidden>' + label + '</div></div>')
